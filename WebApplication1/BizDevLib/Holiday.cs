...
namespace BizDaysLib {
    public class Holiday {
        ...
        public Holiday(int dayOfMonth, int month, bool shiftsIfWeekend, String title) {
        ...
        public Holiday(DayOfWeek dayOfWeek, int weekOfMonth, int month, bool shiftsIfWeekend, String title) {
            if (month < 1 || month > 12) {
                throw new ArgumentException("Value should be between 1 and 12", nameof(month));
            }
